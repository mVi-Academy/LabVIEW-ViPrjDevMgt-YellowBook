...
<Project Type="Project" LVVersion="20008000">
	...
	<Property Name="NI.Project.Description" Type="Str">Contains examples illustrating the use and manipulation of the Waveform data type.</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Support VIs" Type="Folder">
			<Item Name="Acquire Array of Waveforms (simulated).vi" Type="VI" URL="../Support VIs/Acquire Array of Waveforms (simulated).vi"/>
			<Item Name="Acquire Waveform (simulated).vi" Type="VI" URL="../Support VIs/Acquire Waveform (simulated).vi"/>
			<Item Name="Simple Sawtooth Waveform.vi" Type="VI" URL="../Support VIs/Simple Sawtooth Waveform.vi"/>
			<Item Name="Simple Sine Waveform.vi" Type="VI" URL="../Support VIs/Simple Sine Waveform.vi"/>
			<Item Name="Simple Triangle Waveform.vi" Type="VI" URL="../Support VIs/Simple Triangle Waveform.vi"/>
		</Item>
		<Item Name="Waveform - Align Timestamps.vi" Type="VI" URL="../Waveform - Align Timestamps.vi"/>
		<Item Name="Waveform - Append.vi" Type="VI" URL="../Waveform - Append.vi"/>
		<Item Name="Waveform - Common Mathematical Operations.vi" Type="VI" URL="../Waveform - Common Mathematical Operations.vi"/>
		<Item Name="Waveform - Create.vi" Type="VI" URL="../Waveform - Create.vi"/>
		<Item Name="Waveform - Get Final Time and Duration.vi" Type="VI" URL="../Waveform - Get Final Time and Duration.vi"/>
		<Item Name="Waveform - Get Subset.vi" Type="VI" URL="../Waveform - Get Subset.vi"/>
		<Item Name="Waveform - Get Time Array.vi" Type="VI" URL="../Waveform - Get Time Array.vi"/>
		<Item Name="Waveform - Get Y Value.vi" Type="VI" URL="../Waveform - Get Y Value.vi"/>
		<Item Name="Waveform - Index Array.vi" Type="VI" URL="../Waveform - Index Array.vi"/>
		<Item Name="Waveform - Min Max.vi" Type="VI" URL="../Waveform - Min Max.vi"/>
		<Item Name="Waveform - Normalize.vi" Type="VI" URL="../Waveform - Normalize.vi"/>
		<Item Name="Waveform - Scalar Limit Comparison.vi" Type="VI" URL="../Waveform - Scalar Limit Comparison.vi"/>
		<Item Name="Waveform - Scale and Offset.vi" Type="VI" URL="../Waveform - Scale and Offset.vi"/>
		<Item Name="Waveform - Search.vi" Type="VI" URL="../Waveform - Search.vi"/>
		<Item Name="Waveform - Write Waveforms to File.vi" Type="VI" URL="../Waveform - Write Waveforms to File.vi"/>
		<Item Name="Waveform - XY Pairs.vi" Type="VI" URL="../Waveform - XY Pairs.vi"/>
